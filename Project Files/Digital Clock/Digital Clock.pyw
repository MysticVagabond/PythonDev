...
class newDotImage:
    ...
    def createDot(self):
        ...
        pygame.draw.polygon(dot, dotColour, [(14,0), (15,0), (29,14), (29,15), (15,29), (14,29), (0,15), (0,14)], 0)
...
pygame.draw.polygon(clockPiece, clockColour, pointList, 0)

background = pygame.Surface((WINDOWWIDTH, WINDOWHEIGHT)).convert_alpha()
background.fill(BGColour)      # transparent
